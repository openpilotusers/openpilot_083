...
FEATURES = {
  ...
  "use_bsm": set([CAR.GRANDEUR_HEV_19,CAR.SONATA, CAR.PALISADE, CAR.HYUNDAI_GENESIS, CAR.GENESIS_G70,
                  ...
                  CAR.SANTA_FE, CAR.KIA_NIRO_EV, CAR.KIA_SELTOS, KIA_OPTIMA_H]),

  # send LFA MFA message for new HKG models
  "use_lfa_mfa": set([ CAR.PALISADE ]),
}

EV_HYBRID = set([KIA_OPTIMA_H, CAR.GRANDEUR_HEV_19,CAR.IONIQ_EV_2020, CAR.IONIQ_EV_LTD, CAR.IONIQ, CAR.KONA_EV, CAR.KIA_NIRO_EV])
